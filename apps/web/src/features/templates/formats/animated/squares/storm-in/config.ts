...
export const stormInFormat: FormatDefinition = {
  type: 'animated-squares-storm-in',
  name: 'Storm In',
  description: 'Square multi-panel format where content storms in from different directions to assemble the ad. The energetic multi-directional entries pack high impact into a compact square placement perfect for in-feed and sidebar visibility.',
  category: 'animated',
  size: 'squares',
  fields: [
  {
