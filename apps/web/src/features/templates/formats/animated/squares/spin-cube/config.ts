...
export const spinCubeFormat: FormatDefinition = {
  type: 'animated-squares-spin-cube',
  name: 'Spin Cube',
  description: 'Square four-panel spinning cube rotating through graphic and text content for an engaging 3D presentation. The interactive spin invites users to explore each face, making it effective for new arrivals, product ranges, and multi-feature showcases.',
  category: 'animated',
  size: 'squares',
  fields: [
  {
