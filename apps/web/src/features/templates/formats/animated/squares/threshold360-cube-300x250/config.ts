...
export const threshold360Cube300x250Format: FormatDefinition = {
  type: 'animated-squares-threshold360-cube-300x250',
  name: 'THRESHOLD360 CUBE',
  description: 'A 300×250 four-panel cube powered by Threshold360, combining spatial imagery with interactive panel content. The fixed 300×250 size fits standard ad slots while offering an immersive cube experience that stands out in programmatic placements.',
  category: 'animated',
  size: 'squares',
  fields: [
  {
