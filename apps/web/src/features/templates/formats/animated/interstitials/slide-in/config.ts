...
export const slideInFormat: FormatDefinition = {
  type: 'animated-interstitials-slide-in',
  name: 'Slide In',
  description: 'Four panels that slide into view sequentially, blending graphic and text content into a smooth full-screen experience. The sliding motion creates a natural reading flow, guiding users through each message before landing on a strong call to action.',
  category: 'animated',
  size: 'interstitials',
  fields: [
  {
