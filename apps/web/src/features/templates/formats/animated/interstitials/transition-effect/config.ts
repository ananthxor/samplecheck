...
export const transitionEffectFormat: FormatDefinition = {
  type: 'animated-interstitials-transition-effect',
  name: 'Transition Effect',
  description: 'Full-screen interstitial using a smooth visual transition to bring graphic and text content into frame over a background image. The polished, fluid motion lends a premium feel suited to beauty, fashion, and lifestyle brand storytelling.',
  category: 'animated',
  size: 'interstitials',
  fields: [
