...
export const stormInFormat: FormatDefinition = {
  type: 'animated-interstitials-storm-in',
  name: 'Storm In',
  description: 'Multi-panel interstitial where content dramatically storms in from different directions to build the complete ad. The high-energy entrance animations grab attention instantly, making this a strong pick for product launches and bold brand statements.',
  category: 'animated',
  size: 'interstitials',
  fields: [
  {
