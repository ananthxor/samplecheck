...
export const slideInVariantFormat: FormatDefinition = {
  type: 'animated-interstitials-slide-in-variant',
  name: 'Slide In (Variant)',
  description: 'A variant of the four-panel slide-in interstitial with alternate transition behaviour for added visual variety. Offers the same multi-panel storytelling power with a fresh animation twist to keep campaigns feeling new.',
  category: 'animated',
  size: 'interstitials',
  fields: [
  {
