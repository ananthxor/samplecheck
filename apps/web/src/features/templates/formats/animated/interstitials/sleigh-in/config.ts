...
export const sleighInFormat: FormatDefinition = {
  type: 'animated-interstitials-sleigh-in',
  name: 'Sleigh In',
  description: 'Full-screen interstitial where graphic and text content sleighs in over a background image to complete the ad narrative. The playful sliding motion adds a festive touch, making it a natural fit for holiday promotions and seasonal gift campaigns.',
  category: 'animated',
  size: 'interstitials',
  fields: [
