...
export const stormInFormat: FormatDefinition = {
  type: 'animated-banner-storm-in',
  name: 'Storm In',
  description: 'Multi-panel banner where content storms in from multiple directions, assembling the full ad message on screen. The dynamic multi-directional entrances make this banner format stand out in crowded page layouts and drive high engagement.',
  category: 'animated',
  size: 'banner',
  fields: [
  {
