-- =============================================================================
-- Fix fetch_metrics_range: simplify to flat SELECT, add SET search_path
-- =============================================================================
-- Replaces the CTE-based version with a simpler flat query matching the
-- pattern of fetch_hourly_metrics and fetch_device_breakdown.
-- engagement_metrics returns '{}' for now — main KPI counts are the priority.
-- =============================================================================
