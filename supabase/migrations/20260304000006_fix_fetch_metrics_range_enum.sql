-- Fix: remove 'presence' from event_type comparison — not a valid enum value.
-- The CASE WHEN clause was casting 'presence'::event_type on every call,
-- causing 22P02 (invalid input value for enum) and a 400 on every request.
