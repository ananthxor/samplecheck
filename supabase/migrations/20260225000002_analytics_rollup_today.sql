...
BEGIN
  WITH upserted AS (
    ...
    SELECT
      ...
      COALESCE(SUM(CASE WHEN (event_type = 'engagement' OR event_type = 'presence') AND ae.extra_data->>'dwell_time_ms' ~ '^[0-9]+$' THEN (ae.extra_data->>'dwell_time_ms')::BIGINT ELSE 0 END), 0)
