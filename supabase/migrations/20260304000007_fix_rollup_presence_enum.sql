-- Fix: remove 'presence' from event_type comparisons in rollup functions.
-- 'presence' is not a valid event_type enum value — comparing against it
-- causes 22P02 (invalid input value for enum) on every rollup call.
-- This was the root cause of rollup_today_metrics returning 400 all along.
